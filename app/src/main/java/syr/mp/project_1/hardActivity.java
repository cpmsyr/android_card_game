...
public class hardActivity extends AppCompatActivity {
    ...
    cardPicks hardPicks = new cardPicks();
    GameEngine ge = new GameEngine(hardPicks, hardActivity.this);
    ArrayList<Integer> cardValues = ge.cardDrawList(12);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hiddenValues.put("7",cardValues.get(6));
        hiddenValues.put("8",cardValues.get(7));
        hiddenValues.put("9",cardValues.get(8));
        hiddenValues.put("10",cardValues.get(9));
        hiddenValues.put("11",cardValues.get(10));
        hiddenValues.put("12",cardValues.get(11));
    ...
    public void Click_1(View v) {
        ...
        int matches = hardPicks.getMatches();
        ...
        if (matchCheck) {
            ...
            int ivId1 = hardPicks.getIvId1();
            int ivId2 = hardPicks.getIvId2();

            imageView1 = (ImageView) findViewById(ivId1);
            imageView2 = (ImageView) findViewById(ivId2);

            //do mapping of hidden value to real
            String tag1 =hardPicks.getTag1();
            String tag2 =hardPicks.getTag2();
            ...
            if(c1==0){
                ...
                imageView1.setImageResource(R.drawable.num6);
            }
            else if(c1==7){
                imageView1.setImageResource(R.drawable.num7);
            }
            else if(c1==8){
                imageView1.setImageResource(R.drawable.num8);
            }
            else if(c1==9){
                imageView1.setImageResource(R.drawable.num9);
            }
            else if(c1==10){
                imageView1.setImageResource(R.drawable.num10);
            }
            else if(c1==11){
                imageView1.setImageResource(R.drawable.num11);
            }
            ...
            if(c2==0){
                ...
                imageView2.setImageResource(R.drawable.num11);
            }

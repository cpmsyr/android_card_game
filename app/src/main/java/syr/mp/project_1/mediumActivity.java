...
public class mediumActivity extends AppCompatActivity {
    ...
    cardPicks mediumPicks = new cardPicks();
    GameEngine ge = new GameEngine(mediumPicks, mediumActivity.this);
    ArrayList<Integer> cardValues = ge.cardDrawList(8);
    HashMap<String, Integer> hiddenValues = new HashMap<String, Integer>();
    ...
    public void Click_1(View v) {
        ...
        int matches = mediumPicks.getMatches();
        ...
        int tries = mediumPicks.getTries();
        ...
        if (matchCheck) {
            ...
            int ivId1 = mediumPicks.getIvId1();
            int ivId2 = mediumPicks.getIvId2();

            imageView1 = (ImageView) findViewById(ivId1);
            imageView2 = (ImageView) findViewById(ivId2);

            //do mapping of hidden value to real
            String tag1 =mediumPicks.getTag1();
            String tag2 =mediumPicks.getTag2();
